...
export default function AlternateForms({ varieties }) {
  ...
  // ถ้าไม่มี alternate forms → แสดงข้อความแทน
  if (varieties.length <= 1) {
    return (
      <div className="alternative-container">
        <h2 className="alt-title">Alternate Forms</h2>
        <p style={{ color: "#FDFAF6", fontStyle: "italic", marginTop: "0.5rem" }}>
          No alternate forms
        </p>
      </div>
    );
      ...
      <div className="alternative-container">
        ...
        <div className="alt-slider">
          ...
          >
            <img
              src={
                currentForm.sprites?.other?.["official-artwork"]?.front_default ??
                currentForm.sprites?.front_default
              }
